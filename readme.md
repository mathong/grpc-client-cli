...
- Linux: `curl -L https://github.com/mathong/grpc-client-cli/releases/download/v1.21.0/grpc-client-cli_linux_x86_64.tar.gz | tar -C /usr/local/bin -xz` (you might need to add `sudo` before tar)
- macOS: `curl -L https://github.com/mathong/grpc-client-cli/releases/download/v1.21.0/grpc-client-cli_darwin_x86_64.tar.gz | tar -C /usr/local/bin -xz`

For go `1.17+` use this command to install the app to `$GOPATH/bin` directory:

- `go install github.com/mathong/grpc-client-cli/cmd/grpc-client-cli@v1.21.0`
- `go install github.com/mathong/grpc-client-cli/cmd/grpc-client-cli@latest`
